...
public class RRAuto4 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectorySequence returnToZone = drive.trajectorySequenceBuilder(new Pose2d(4, -32.5, Math.toRadians(90.00)))
                .setReversed(true)
